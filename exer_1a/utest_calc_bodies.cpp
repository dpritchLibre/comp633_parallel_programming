...
extern "C" void calc_bodies_blk(struct vec_2d *r,
				struct vec_2d *v,
				const double *m,
				double g,
				double dt,
...
public:
	...
	// these test inputs were provided by Jan Prins on the class website
    ...
    void test_calc_bodies_blk_1() {

	// exercise function
	calc_bodies_blk_k_step(6325914, 1);
    ...
    void calc_bodies_blk_k_step(size_t k, size_t blk_size) {
    ...
    CPPUNIT_TEST(test_calc_bodies_blk_1);
